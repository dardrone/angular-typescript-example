module app.productList {
	...
	class ProductListCtrl implements IProductListModel {
		...
		constructor() {
			...
			var newProduct = new app.domain.Product(3, "Saw", "TBX-002", new Date(2002, 3, 1), 16.95, "15 in steel blade",
				"http://openclipart.org/image/300px/svg_to_png/27070/egore911-saw.png");
